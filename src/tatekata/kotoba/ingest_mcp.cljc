#!/usr/bin/env bb
;; tatekata 建方 — ingest seed.edn into a live kotoba node (cljc port of ingest_mcp.py).
;; ADR-2605250715.
...
(def default-graph "com.etzhayyim.tatekata")

#?(:clj
   (def seed-path
     (str (io/file "." "data" "kotoba-seed.edn"))))
