...
(defn collection
  [name]
  (str "com.etzhayyim.tatekata." name))

(def cell-specs {
  :foundation_excavation {:legacy-cell "foundation-excavation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "foundation_excavation")]
     :required-gates common-gates
     :trigger "manifest cell foundation_excavation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :structural_assembly {:legacy-cell "structural-assembly"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "structural_assembly")]
     :required-gates common-gates
     :trigger "manifest cell structural_assembly"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :mep_installation {:legacy-cell "mep-installation"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "mep_installation")]
     :required-gates common-gates
     :trigger "manifest cell mep_installation"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :finishing_handoff {:legacy-cell "finishing-handoff"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "finishing_handoff")]
     :required-gates common-gates
     :trigger "manifest cell finishing_handoff"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :commissioning {:legacy-cell "commissioning"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "commissioning")]
     :required-gates common-gates
     :trigger "manifest cell commissioning"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
